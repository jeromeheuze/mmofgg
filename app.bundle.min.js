...
function XM_Arc() {
    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, o = {
        ...
        shadowColor: "#000",
        shadowBlur: 30
    }, a = document.createElement("canvas"), s = a.getContext("2d"), n = this;
    n.done = !1, n.config = o;
    var t = function (e, n) {
        var t = n[0], a = n.substring(1);
    ...
    }))), o.speed = o.speed <= 0 ? 1 : o.speed, o.speed = 100 < o.speed ? 100 : o.speed, o.animation.step = Math.PI / (2e3 / o.speed), function () {
        if (o.gradient) {
...
function XM_Countdown() {
    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {}, n = {
        ...
        textOnle: !1,
        global: {
            underlineConfig: {width: 112, height: 112, lineWidth: 10, lineColor: "#2c194f", linkText: !1},
            arcConfig: {
                width: 112,
                height: 112,
                lineWidth: 10,
        ...
        var t = e.daysLeft <= 0, n = e.hoursLeft <= 0, r = e.minutesLeft <= 0, o = e.secondsLeft <= 0;
        return t && n && r && o
    }, C = function () {
        var e = a();
...
function XM_Calendar(e) {
    var r = {
        ...
        weekDaysEl: {container: ".calendar-header-bottom", child: {selectors: ["calendar-week-day"], elementType: "p"}},
        daysEl: {
        ...
        controls: {container: ".calendar-controls", right: ".control-next", left: ".control-previous"},
        displayDate: {year: (new Date).getFullYear(), month: (new Date).getMonth()},
        ...
        months: {enUS: ["January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"]},
        events: [],
        calendarRowLength: 7,
        writeEvents: !0,
        showEventsOnHover: !1
    }, n = this, t = function () {
        if (window.innerWidth <= r.lang.breakpoint) for (var e = 0; e < r.weekDaysEl.el.children.length; e++) r.weekDaysEl.el.children[e].innerHTML = r.days[r.lang.idiom].short[e]; else for (var n = 0; n < r.weekDaysEl.el.children.length; n++) r.weekDaysEl.el.children[n].innerHTML = r.days[r.lang.idiom].long[n]
    }, a = function () {
        ...
        r.calendarDays = [];
        var e = {year: r.displayDate.year, month: r.displayDate.month, day: 1}, n = new Date(e.year, e.month, e.day),
            t = n.getDay(), a = e.month;
        ...
        var n = new Date, t = n.getFullYear() === e.getFullYear(), a = n.getMonth() === e.getMonth(),
...
function XM_Dropdown(o) {
    var e = {triggerEvent: "click", offset: {}, animation: {type: "slide", speed: 400}, selectable: !1, forceClose: !1},
        n = this, t = function () {
...
function XM_Lineslide(e) {
    var t = {speed: 1, startOffset: 0, stopOnHover: !0}, i = this, n = function () {
...
function XM_ProgressBar(d) {
    ...
    }, o = document.createElement("canvas"), r = o.getContext("2d"), l = this, h = function (e) {
        var t = document.createElement("div");
    ...
    !function () {
        ...
        }) : p.controlAnimation || x(), void 0 !== p.split) if (void 0 !== p.split.parts) for (var e = (p.width - p.split.gap * (p.split.parts - 1)) / p.split.parts, t = -p.split.gap, n = 0; n < p.split.parts; n++) h({
            width: p.split.gap,
            color: p.split.color,
            offset: t,
            partWidth: e
        }), t += e + p.split.gap; else if (void 0 !== p.split.partItems) {
            var i = 0, o = !0, r = !1, l = void 0;
            try {
...
function XM_Slider(n) {
    var l = {
        ...
        lock: !0,
        stopAtEnd: !1,
        rosterControls: {activeClass: "active", haltedClass: "halted", triggerEvent: "click"},
        sliderItems: {activeClass: "active", haltedClass: "halted"},
        controls: {previousSelector: ".control-previous", nextSelector: ".control-next", disabledClass: "disabled"},
        animation: {
            type: "carousel",
        ...
        if (l.itemsContainerItem.parentElement.style.position = "relative", l.itemsContainerItem.parentElement.style.overflow = "hidden", l.itemsContainerItem.style.position = "absolute", l.itemsContainerItem.style.top = 0, l.itemsContainerItem.style.left = 0, "static" === l.animation.type || "fade" === l.animation.type) for (var t = 0, e = l.newsItems.length; t < e; t++) l.newsItems[t].style.position = "absolute", l.newsItems[t].style.top = 0, l.newsItems[t].style.left = 0, t !== l.currentIndex ? l.newsItems[t].style.opacity = 0 : l.newsItems[t].style.zIndex = 2;
        if ("carousel" === l.animation.type) if ("vertical" === l.animation.orientation && (l.animation.slideOffset || (l.animation.slideOffset = l.newsItems[0].offsetHeight)), "horizontal" === l.animation.orientation && (l.animation.slideOffset || (l.animation.slideOffset = l.newsItems[0].offsetWidth)), l.animation.slideGap && (l.animation.slideOffset += l.animation.slideGap), l.loopOffset && "horizontal" === l.animation.orientation && (l.itemsContainerItem.style.left = "".concat(l.animation.slideOffset * l.loopOffset, "px")), "step" === l.animation.transition) for (var n = 0, i = 0, o = l.newsItems.length; i < o; i++) l.newsItems[i].style.position = "absolute", "vertical" === l.animation.orientation && (l.newsItems[i].style.top = "".concat(n, "px"), l.newsItems[i].style.left = 0), "horizontal" === l.animation.orientation && (l.newsItems[i].style.left = "".concat(n, "px"), l.newsItems[i].style.top = 0), n += l.animation.slideOffset; else if ("direct" === l.animation.transition) {
            var s = 0;
    ...
    m.startSlider = function () {
        ...
        if (!m.started) {
            if (m.started = !0, l.rosterContainer) for (var e = 0, n = l.rosterItems.length; e < n; e++) l.rosterItems[e].classList.remove(l.rosterControls.haltedClass);
        ...
        if (m.started) {
            if (m.started = !1, window.clearInterval(m.intID), l.rosterContainer) for (var t = 0, e = l.rosterItems.length; t < e; t++) l.rosterItems[t].classList.add(l.rosterControls.haltedClass);
    ...
    var p = function () {
        ...
        var t, e, n,
            i = "vertical" === l.animation.orientation ? "top" : "horizontal" === l.animation.orientation ? "left" : "",
    ...
    !function () {
        if (D(l, n), s(), c(), I(), u(), l.rosterContainer && d(), l.controls.container && r(), l.slideOnClick && a(), l.autoSlide) m.startSlider(l.startIndex); else if (h(l.startIndex), l.rosterContainer) for (var t = 0, e = l.rosterItems.length; t < e; t++) l.rosterItems[t].classList.add(l.rosterControls.haltedClass);
...
function XM_Tab(t) {
    var c = {
        ...
        selectedClass: "selected",
        startIndex: 1,
        animation: {type: "static", ease: "ease-in-out", speed: .3, translateOffset: 100}
    }, d = {}, e = function () {
        a()
    }, n = function () {
        ...
        var t = !0, e = !(d.tabs = []), n = void 0;
        try {
            for (var o, a = d.tabElements[Symbol.iterator](); !(t = (o = a.next()).done); t = !0) {
                var r = o.value, l = {}, s = (l.tabContainer = r).querySelector(c.tabControls),
...
!function a(o, s, l) {
    ...
    1: [function (e, t, n) {
        ...
        i = this, a = function (i) {
            ...
            var a = {
                ...
                hsv2rgb: u,
                hsv2hsl: function (e) {
                    var t, n, i = e[0], r = e[1] / 100, a = e[2] / 100;
            ...
            function o(e) {
                var t, n, i = e[0] / 255, r = e[1] / 255, a = e[2] / 255, o = Math.min(i, r, a), s = Math.max(i, r, a),
                    l = s - o;
            ...
            function t(e) {
                var t, n, i = e[0], r = e[1], a = e[2], o = Math.min(i, r, a), s = Math.max(i, r, a), l = s - o;
            ...
            function p(e) {
                var t, n, i, a, o = e[0] / 360, s = e[1] / 100, l = e[2] / 100, c = s + l;
            ...
            for (var T in a) {
                ...
                var P = /(\w+)2(\w+)/.exec(T), D = P[1], O = P[2];
            ...
            var A = C, L = {
                ...
                getRgba: V, getHsla: I, getRgb: function (e) {
                    var t = V(e);
                    return t && t.slice(0, 3)
                }, getHsl: function (e) {
                    var t = I(e);
                    return t && t.slice(0, 3)
                }, getHwb: z, getAlpha: function (e) {
                    var t = V(e);
                    {
                        if (t) return t[3];
                        if (t = I(e)) return t[3];
                ...
                }, rgbaString: H, percentString: function (e, t) {
            ...
            var G, q = j, X = {
                noop: function () {
                    ...
                    var r, a, o;
                    if (X.isArray(e)) if (a = e.length, i) for (r = a - 1; 0 <= r; r--) t.call(n, e[r], r); else for (r = 0; r < a; r++) t.call(n, e[r], r); else if (X.isObject(e)) for (a = (o = Object.keys(e)).length, r = 0; r < a; r++) t.call(n, e[o[r]], o[r])
                    ...
                    var i, r, a, o, s, l = X.isArray(t) ? t : [t], c = l.length;
                    if (!X.isObject(e)) return e;
                    for (i = (n = n || {}).merger || X._merger, r = 0; r < c; ++r) if (t = l[r], X.isObject(t)) for (s = 0, o = (a = Object.keys(t)).length; s < o; ++s) i(a[s], e, t, n);
                    return e
            ...
            Z.easingEffects = $;
            var J = Math.PI, Q = J / 180, ee = 2 * J, te = J / 2, ne = J / 4, ie = 2 * J / 3, re = {
                clear: function (e) {
            ...
            var ce = {
                toLineHeight: function (e, t) {
                    ...
                    var t, n = se.global, i = le(e.fontSize, n.defaultFontSize), r = {
                    ...
                    var i, r, a;
                    for (i = 0, r = e.length; i < r; ++i) if (void 0 !== (a = e[i]) && (void 0 !== t && "function" == typeof a && (a = a(t)), void 0 !== n && Z.isArray(a) && (a = a[n]), void 0 !== a)) return a
                }
            }, de = Z, he = K, ue = ae, pe = ce;
            ...
            de.extend(ge.prototype, {
                initialize: function () {
                    ...
                    return n && 1 !== e ? (r || (r = t._view = {}), i || (i = t._start = {}), function (e, t, n, i) {
                        ...
                        for (r = 0, a = p.length; r < a; ++r) if (c = n[o = p[r]], t.hasOwnProperty(o) || (t[o] = c), (s = t[o]) !== c && "_" !== o[0]) {
            ...
            }, ye = de.options.resolve, we = ["push", "pop", "shift", "splice", "unshift"];

            function xe(t, e) {
                var n = t._chartjs;
                if (n) {
                    var i = n.listeners, r = i.indexOf(e);
                    -1 !== r && i.splice(r, 1), 0 < i.length || (we.forEach(function (e) {
                        delete t[e]
                    }), delete t._chartjs)
                }
            }
            ...
            de.extend(ke.prototype, {
                ...
                }, update: de.noop, transition: function (e) {
            ...
            var _e = fe.extend({
                inLabelRange: function (e) {
                    ...
                    var e, t = this._chart.ctx, n = this._view, i = n.startAngle, r = n.endAngle,
            ...
            }), Se = de.valueOrDefault, Ce = se.global.defaultColor;
            se._set("global", {
                elements: {
                    line: {
                        tension: .4,
            ...
            var Te = fe.extend({
                draw: function () {
                    var e, t, n, i, r = this._view, a = this._chart.ctx, o = r.spanGaps, s = this._children.slice(),
                        l = se.global, c = l.elements.line, d = -1;
            ...
            }), Pe = de.valueOrDefault, De = se.global.defaultColor;
            ...
            var Be = fe.extend({
                inRange: function (e, t) {
                ...
                }, inLabelRange: Oe, inXRange: Oe, inYRange: function (e) {
                    var t = this._view;
                    ...
                    var t = this._view, n = this._chart.ctx, i = t.pointStyle, r = t.rotation, a = t.radius, o = t.x,
                        s = t.y, l = se.global, c = l.defaultColor;
            ...
            function ze(e, t, n) {
                var i = null === t, r = null === n, a = !(!e || i && r) && Re(e);
            ...
            var He = fe.extend({
                draw: function () {
                    var e, t, n, i, r, a = this._chart.ctx, o = this._view,
                    ...
                    return t = Le(n) ? (e = n.x, (n.y + n.base) / 2) : (e = (n.x + n.base) / 2, n.y), {x: e, y: t}
                }, getArea: function () {
                    var e = this._view;
            ...
            var je = Me.extend({
                dataElementType: Fe.Rectangle, initialize: function () {
                    var e;
                    ...
                    var i = this, r = i.getMeta(), a = i.getDataset(), o = i._resolveElementOptions(e, t);
                    ...
                    var i = this, r = e._model, a = i._getValueScale(), o = a.getBasePixel(), s = a.isHorizontal(),
                    ...
                    var t, n, i = this.chart, r = this._getIndexScale().options.stacked,
                        a = void 0 === e ? i.data.datasets.length : e + 1, o = [];
                    ...
                    var e, t, n = this._getIndexScale(), i = this.getStackCount(), r = this.index, a = n.isHorizontal(),
                        o = a ? n.left : n.top, s = o + (a ? n.width : n.height), l = [];
                    ...
                    return {
                        min: de.isNullOrUndef(n.options.barThickness) ? function (e, t) {
                            var n, i, r, a, o = e.isHorizontal() ? e.width : e.height, s = e.getTicks();
                    ...
                    var n, i, r, a, o, s, l = this.chart, c = this.getMeta(), d = this._getValueScale(),
                        h = d.isHorizontal(), u = l.data.datasets, p = +d.getRightValue(u[e].data[t]),
                        g = d.options.minBarLength, f = d.options.stacked, m = c.stack, b = 0;
                    if (f || void 0 === f && void 0 !== m) for (n = 0; n < e; ++n) (i = l.getDatasetMeta(n)).bar && i.stack === m && i.controller._getValueScaleId() === d.id && l.isDatasetVisible(n) && (r = +d.getRightValue(u[n].data[t]), (p < 0 && r < 0 || 0 <= p && 0 < r) && (b += r));
                    ...
                    var i, r, a, o, s, l, c, d, h, u, p, g, f, m, b, v, y, w = n.scale.options,
                        x = "flex" === w.barThickness ? (h = t, p = w, f = (u = n).pixels, m = f[h], b = 0 < h ? f[h - 1] : null, v = h < f.length - 1 ? f[h + 1] : null, y = p.categoryPercentage, null === b && (b = m - (null === v ? u.end - u.start : v - m)), null === v && (v = m + m - b), g = m - (m - Math.min(b, v)) / 2 * y, {
                            ...
                            ratio: s,
                            start: d - o / 2
                        }), k = this.getStackIndex(e, this.getMeta().stack), M = x.start + x.chunk * k + x.chunk / 2,
                        _ = Math.min(de.valueOrDefault(w.maxBarThickness, 1 / 0), x.chunk * x.ratio);
                    return {base: M - _ / 2, head: M + _ / 2, center: M, size: _}
                }, draw: function () {
                    ...
                    var n, i, r, a = this.chart, o = a.data.datasets[this.index], s = e.custom || {},
                        l = a.options.elements.rectangle, c = {},
                        d = {chart: a, dataIndex: t, dataset: o, datasetIndex: this.index},
                        h = ["backgroundColor", "borderColor", "borderSkipped", "borderWidth"];
                    for (n = 0, i = h.length; n < i; ++n) c[r = h[n]] = Ue([s[r], o[r], l[r]], d, t);
                    return c
                }
            }), Ge = de.valueOrDefault, qe = de.options.resolve;
            se._set("bubble", {
                hover: {mode: "single"},
                scales: {
            ...
            var Xe = Me.extend({
                dataElementType: Fe.Point, update: function (n) {
                    ...
                    var i = this, r = i.getMeta(), a = e.custom || {}, o = i.getScaleForId(r.xAxisID),
                        s = i.getScaleForId(r.yAxisID), l = i._resolveElementOptions(e, t), c = i.getDataset().data[t],
                        d = i.index,
                    ...
                    var t = e._model, n = e._options, i = de.getHoverColor;
                    e.$previousStyle = {
                    ...
                    var n, i, r, a = this.chart, o = a.data.datasets[this.index], s = e.custom || {},
                        l = a.options.elements.point, c = o.data[t], d = {},
            ...
            }), Ze = de.options.resolve, $e = de.valueOrDefault;
            se._set("doughnut", {
                ...
                legendCallback: function (e) {
                    ...
                    if (i.length) for (var a = 0; a < i[0].data.length; ++a) t.push('<li><span style="background-color:' + i[0].backgroundColor[a] + '"></span>'), r[a] && t.push(r[a]), t.push("</li>");
                    ...
                    labels: {
                        generateLabels: function (s) {
                            ...
                            return l.labels.length && l.datasets.length ? l.labels.map(function (e, t) {
                                var n = s.getDatasetMeta(0), i = l.datasets[0], r = n.data[t], a = r && r.custom || {},
            ...
            var Ke = Me.extend({
                dataElementType: Fe.Arc, linkScales: de.noop, getRingIndex: function (e) {
                    for (var t = 0, n = 0; n < e; ++n) this.chart.isDatasetVisible(n) && ++t;
                    return t
                }, update: function (e) {
                    var t, n, i = this, r = i.chart, a = r.chartArea, o = r.options, s = a.right - a.left,
                        l = a.bottom - a.top, c = Math.min(s, l), d = {x: 0, y: 0}, h = i.getMeta(), u = h.data,
                        p = o.cutoutPercentage, g = o.circumference, f = i._getRingWeight(i.index);
                    if (g < 2 * Math.PI) {
                        var m = o.rotation % (2 * Math.PI),
                            b = (m += 2 * Math.PI * (m >= Math.PI ? -1 : m < -Math.PI ? 1 : 0)) + g, v = Math.cos(m),
                            y = Math.sin(m), w = Math.cos(b), x = Math.sin(b),
                            ...
                            C = p / 100, T = _ ? -1 : Math.min(v * (v < 0 ? 1 : C), w * (w < 0 ? 1 : C)),
                            P = S ? -1 : Math.min(y * (y < 0 ? 1 : C), x * (x < 0 ? 1 : C)),
                            D = k ? 1 : Math.max(v * (0 < v ? 1 : C), w * (0 < w ? 1 : C)),
                            O = M ? 1 : Math.max(y * (0 < y ? 1 : C), x * (0 < x ? 1 : C)), B = .5 * (D - T),
                            A = .5 * (O - P);
                        c = Math.min(s / B, l / A), d = {x: -.5 * (D + T), y: -.5 * (O + P)}
                    }
                    ...
                    var i = this, r = i.chart, a = r.chartArea, o = r.options, s = o.animation,
                        l = (a.left + a.right) / 2, c = (a.top + a.bottom) / 2, d = o.rotation, h = o.rotation,
                        u = i.getDataset(),
                        p = n && s.animateRotate ? 0 : e.hidden ? 0 : i.calculateCircumference(u.data[t]) * (o.circumference / (2 * Math.PI)),
                        g = n && s.animateScale ? 0 : i.innerRadius, f = n && s.animateScale ? 0 : i.outerRadius,
                        m = e._options || {};
                    de.extend(e, {
                    ...
                    var n, i, r, a = this.chart, o = this.getDataset(), s = e.custom || {}, l = a.options.elements.arc,
                        c = {}, d = {chart: a, dataIndex: t, dataset: o, datasetIndex: this.index},
            ...
            }), Qe = de.valueOrDefault, et = de.options.resolve, tt = de.canvas._isPointInArea;
            ...
            var it = Me.extend({
                datasetElementType: Fe.Line, dataElementType: Fe.Point, update: function (e) {
                    var t, n, i = this, r = i.getMeta(), a = r.dataset, o = r.data || [],
                        s = i.getScaleForId(r.yAxisID), l = i.getDataset(), c = nt(l, i.chart.options);
                    ...
                    var i, r, a = this, o = a.getMeta(), s = e.custom || {}, l = a.getDataset(), c = a.index,
                        d = l.data[t], h = a.getScaleForId(o.yAxisID), u = a.getScaleForId(o.xAxisID),
                        p = o.dataset._model, g = a._resolvePointOptions(e, t);
                    ...
                    var n, i, r, a = this.chart, o = a.data.datasets[this.index], s = e.custom || {},
                        l = a.options.elements.point, c = {},
                        d = {chart: a, dataIndex: t, dataset: o, datasetIndex: this.index}, h = {
                    ...
                    var t, n, i, r = this.chart, a = r.data.datasets[this.index], o = e.custom || {}, s = r.options,
                        l = s.elements.line, c = {},
                    ...
                    var i, r, a, o = this.chart, s = this.getMeta(), l = this.getScaleForId(s.yAxisID), c = 0, d = 0;
                    if (l.options.stacked) {
                        for (i = 0; i < n; i++) if (r = o.data.datasets[i], "line" === (a = o.getDatasetMeta(i)).type && a.yAxisID === l.id && o.isDatasetVisible(i)) {
                    ...
                    var e, t = this.chart, n = this.getMeta(), i = n.data || [], r = t.chartArea, a = i.length, o = 0;
                    ...
                    labels: {
                        generateLabels: function (o) {
                            ...
                            return s.labels.length && s.datasets.length ? s.labels.map(function (e, t) {
                                var n = o.getDatasetMeta(0), i = s.datasets[0], r = n.data[t].custom || {},
            ...
            var at = Me.extend({
                dataElementType: Fe.Arc, linkScales: de.noop, update: function (e) {
                    ...
                    var i = this, r = i.chart, a = i.getDataset(), o = r.options, s = o.animation, l = r.scale,
                        c = r.data.labels, d = l.xCenter, h = l.yCenter, u = o.startAngle,
                        p = e.hidden ? 0 : l.getDistanceFromCenterForValue(a.data[t]), g = i._starts[t],
                        f = g + (e.hidden ? 0 : i._angles[t]),
                        m = s.animateScale ? 0 : l.getDistanceFromCenterForValue(a.data[t]), b = e._options || {};
                    de.extend(e, {
                        _datasetIndex: i.index,
                        _index: t,
                        _scale: l,
                    ...
                    var t = e._model, n = e._options, i = de.getHoverColor, r = de.valueOrDefault;
                    e.$previousStyle = {
                        backgroundColor: t.backgroundColor,
                        borderColor: t.borderColor,
                        borderWidth: t.borderWidth
            ...
            se._set("pie", de.clone(se.doughnut)), se._set("pie", {cutoutPercentage: 0});
            var ot = Ke, st = de.valueOrDefault, lt = de.options.resolve;
            se._set("radar", {scale: {type: "radialLinear"}, elements: {line: {tension: 0}}});
            var ct = Me.extend({
                datasetElementType: Fe.Line, dataElementType: Fe.Point, linkScales: de.noop, update: function (e) {
                    ...
                    var i = this, r = e.custom || {}, a = i.getDataset(), o = i.chart.scale,
                        s = o.getPointPositionForValue(t, a.data[t]), l = i._resolvePointOptions(e, t),
                        c = i.getMeta().dataset._model, d = n ? o.xCenter : s.x, h = n ? o.yCenter : s.y;
                    ...
                    var t, n, i, r = this.chart, a = r.data.datasets[this.index], o = e.custom || {},
                        s = r.options.elements.line, l = {},
            ...
            function ut(e, t) {
                var n, i, r, a, o;
                for (i = 0, a = e.data.datasets.length; i < a; ++i) if (e.isDatasetVisible(i)) for (r = 0, o = (n = e.getDatasetMeta(i)).data.length; r < o; ++r) {
                    var s = n.data[r];
                    s._view.skip || t(s)
                }
            }
            ...
            function mt(i, e, t) {
                var n = ht(e, i);
                t.axis = t.axis || "x";
                var r = ft(t.axis), a = t.intersect ? pt(i, n) : gt(i, n, !1, r), o = [];
            ...
            var bt = {
                modes: {
                    ...
                    }, label: mt, index: mt, dataset: function (e, t, n) {
                        var i = ht(t, e);
                        n.axis = n.axis || "xy";
                        var r = ft(n.axis), a = n.intersect ? pt(e, i) : gt(e, i, !1, r);
            ...
            var xt = {
                defaults: {}, addBox: function (e, t) {
                    ...
                    if (t) {
                        var i = t.options.layout || {}, r = de.options.toPadding(i.padding), a = r.left, o = r.right,
                            s = r.top, l = r.bottom, c = vt(t.boxes, "left"), d = vt(t.boxes, "right"),
                            h = vt(t.boxes, "top"), u = vt(t.boxes, "bottom"), p = vt(t.boxes, "chartArea");
                        yt(c, !0), yt(d, !1), yt(h, !0), yt(u, !1);
                        var g, f, m, b, v, y, w = c.concat(d), x = h.concat(u), k = w.concat(x), M = n - a - o,
                            _ = e - s - l, S = (n - M / 2) / w.length, C = M, T = _,
                            P = {top: s, left: a, bottom: l, right: o}, D = [];
                        ...
                        var A = e - P.top - P.bottom, L = n - P.left - P.right;
            ...
            var kt,
                Mt = (kt = Object.freeze({default: "/*\n * DOM element rendering detection\n * https://davidwalsh.name/detect-node-insertion\n */\n@keyframes chartjs-render-animation {\n\tfrom { opacity: 0.99; }\n\tto { opacity: 1; }\n}\n\n.chartjs-render-monitor {\n\tanimation: chartjs-render-animation 0.001s;\n}\n\n/*\n * DOM element resizing detection\n * https://github.com/marcj/css-element-queries\n */\n.chartjs-size-monitor,\n.chartjs-size-monitor-expand,\n.chartjs-size-monitor-shrink {\n\tposition: absolute;\n\tdirection: ltr;\n\tleft: 0;\n\ttop: 0;\n\tright: 0;\n\tbottom: 0;\n\toverflow: hidden;\n\tpointer-events: none;\n\tvisibility: hidden;\n\tz-index: -1;\n}\n\n.chartjs-size-monitor-expand > div {\n\tposition: absolute;\n\twidth: 1000000px;\n\theight: 1000000px;\n\tleft: 0;\n\ttop: 0;\n}\n\n.chartjs-size-monitor-shrink > div {\n\tposition: absolute;\n\twidth: 200%;\n\theight: 200%;\n\tleft: 0;\n\ttop: 0;\n}\n"})) && kt.default || kt,
                _t = "$chartjs", St = "chartjs-", Ct = St + "size-monitor", Tt = St + "render-monitor",
                Pt = St + "render-animation", Dt = ["animationstart", "webkitAnimationStart"], Ot = {
            ...
            function Bt(e, t) {
                var n = de.getStyle(e, t), i = n && n.match(/^(\d+)(\.\d+)?px$/);
            ...
            function zt(n, i, r) {
                var e, t, a, o, s, l, c, d, h = n[_t] || (n[_t] = {}), u = h.resizer = function (e) {
                    var t = It(Ct), n = It(Ct + "-expand"), i = It(Ct + "-shrink");
            ...
            var jt = {
                average: function (e) {
                    ...
                    for (n = 0, i = e.length; n < i; ++n) {
                        var l = e[n];
                        if (l && l.hasValue()) {
                            var c = l.getCenterPoint(), d = de.distanceBetweenPoints(t, c);
                            d < s && (s = d, r = l)
                        }
                    }
                    if (r) {
            ...
            var Kt = fe.extend({
                initialize: function () {
                    ...
                    var t, n, i, r, a, o, s, l, c, d, h, u, p, g, f, m, b, v, y, w, x, k, M, _ = this, S = _._options,
                        C = _._model, T = _._model = Xt(S), P = _._active, D = _._data,
                        O = {xAlign: C.xAlign, yAlign: C.yAlign}, B = {x: C.x, y: C.y},
                        A = {width: C.width, height: C.height}, L = {x: C.caretX, y: C.caretY};
                    if (P.length) {
                        T.opacity = 1;
                        var R = [], V = [];
                        ...
                        S.filter && (I = I.filter(function (e) {
                            ...
                            var u = (c.left + c.right) / 2, p = (c.top + c.bottom) / 2;
                    ...
                    var i, r, a, o, s, l, c = n.caretSize, d = n.cornerRadius, h = n.xAlign, u = n.yAlign, p = e.x,
                        g = e.y, f = t.width, m = t.height;
                    if ("center" === u) s = g + m / 2, l = "left" === h ? (r = (i = p) - c, a = i, o = s + c, s - c) : (r = (i = p + f) + c, a = i, o = s - c, s + c); else if (a = (i = "left" === h ? (r = p + d + c) - c : "right" === h ? (r = p + f - d - c) - c : (r = n.caretX) - c, r + c), "top" === u) s = (o = g) - c, l = o; else {
                        s = (o = g + m) + c, l = o;
                        var b = a;
                        a = i, i = b
                    }
                    ...
                    if (i.length) {
                        ...
                        var r, a, o = t.titleFontSize, s = t.titleSpacing;
                    ...
                    var a, o = i.bodyFontSize, t = i.bodySpacing, e = i._bodyAlign, s = i.body, l = i.displayColors,
                        c = i.labelColors, d = 0, h = l ? Zt(i, "left") : 0;
            ...
            de.extend(an.prototype, {
                construct: function (e, t) {
                    ...
                    var a = Et.acquireContext(e, t), o = a && a.canvas, s = o && o.height, l = o && o.width;
                    ...
                    e.scales && (t = t.concat((e.scales.xAxes || []).map(function (e) {
                        ...
                        var t = e.options, n = t.id, i = en(t.type, e.dtype);
                    ...
                    return de.each(a.data.datasets, function (e, t) {
                        var n = a.getDatasetMeta(t), i = e.type || a.config.type;
                        if (n.type && n.type !== i && (a.destroyDatasetMeta(t), n = a.getDatasetMeta(t)), n.type = i, n.controller) n.controller.updateIndex(t), n.controller.linkScales(); else {
                            var r = dt[n.type];
                    ...
                    var n = t.options.animation, i = en(e.duration, n && n.duration), r = e.lazy;
                        ...
                        if (n && i) {
                            var o = new be({
                                numSteps: i / 16.66, easing: e.easing || n.easing, render: function (e, t) {
                                    var n = de.easing.effects[t.easing], i = t.currentStep, r = i / t.numSteps;
                                    e.draw(n(r), r, i)
            ...
            }, hn = de.valueOrDefault, un = de.valueAtIndexOrDefault;
            ...
            var fn = fe.extend({
                ...
                calculateTickRotation: function () {
                    var e = this, t = e.ctx, n = e.options.ticks, i = pn(e._ticks), r = de.options._parseFont(n);
                    t.font = r.string;
                    var a = n.minRotation || 0;
                    if (i.length && e.options.display && e.isHorizontal()) for (var o, s = de.longestText(t, r.string, i, e.longestTextCache), l = s, c = e.getPixelForTick(1) - e.getPixelForTick(0) - 6; c < l && a < n.maxRotation;) {
                ...
                fit: function () {
                    var e = this, t = e.minSize = {width: 0, height: 0}, n = pn(e._ticks), i = e.options, r = i.ticks,
                        a = i.scaleLabel, o = i.gridLines, s = e._isVisible(), l = i.position, c = e.isHorizontal(),
                        d = de.options._parseFont, h = d(r), u = i.gridLines.tickMarkLength;
                    if (t.width = c ? e.isFullWidth() ? e.maxWidth - e.margins.left - e.margins.right : e.maxWidth : s && o.drawTicks ? u : 0, t.height = c ? s && o.drawTicks ? u : 0 : e.maxHeight, a.display && s) {
                        var p = d(a), g = de.options.toPadding(a.padding), f = p.lineHeight + g.height;
                        c ? t.height += f : t.width += f
                    }
                    if (r.display && s) {
                        var m = de.longestText(e.ctx, h.string, n, e.longestTextCache), b = de.numberOfLabelLines(n),
                            v = .5 * h.size, y = e.options.ticks.padding;
                        if (e._maxLabelLines = b, e.longestLabelWidth = m, c) {
                            var w = de.toRadians(e.labelRotation), x = Math.cos(w),
                                k = Math.sin(w) * m + h.lineHeight * b + v;
                            t.height = Math.min(e.maxHeight, t.height + k + y), e.ctx.font = h.string;
                            var M, _, S = gn(e.ctx, n[0], h.string), C = gn(e.ctx, n[n.length - 1], h.string),
                                T = e.getPixelForTick(0) - e.left, P = e.right - e.getPixelForTick(n.length - 1);
                ...
                getPixelForDecimal: function (e) {
                    var t = this;
                    if (t.isHorizontal()) {
                        var n = (t.width - (t.paddingLeft + t.paddingRight)) * e + t.paddingLeft, i = t.left + n;
                ...
                _autoSkip: function (e) {
                    var t, n, i = this, r = i.isHorizontal(), a = i.options.ticks.minor, o = e.length, s = !1,
                        l = a.maxTicksLimit, c = i._tickSize() * (o - 1),
                ...
                _tickSize: function () {
                    var e = this, t = e.isHorizontal(), n = e.options.ticks.minor, i = de.toRadians(e.labelRotation),
                        r = Math.abs(Math.cos(i)), a = Math.abs(Math.sin(i)), o = n.autoSkipPadding || 0,
                        s = e.longestLabelWidth + o || 0, l = de.options._parseFont(n),
                ...
                draw: function (T) {
                    var P = this, D = P.options;
                    if (P._isVisible()) {
                        var e, O, B, A = P.chart, o = P.ctx, t = se.global.defaultFontColor, s = D.ticks.minor,
                            n = D.ticks.major || s, L = D.gridLines, i = D.scaleLabel, R = D.position,
                            V = 0 !== P.labelRotation, I = s.mirror, z = P.isHorizontal(), r = de.options._parseFont,
                            a = s.display && s.autoSkip ? P._autoSkip(P.getTicks()) : P.getTicks(),
                            l = hn(s.fontColor, t), c = r(s), H = c.lineHeight, d = hn(n.fontColor, t), h = r(n),
                            F = s.padding, W = s.labelOffset, E = L.drawTicks ? L.tickMarkLength : 0,
                            u = hn(i.fontColor, t), p = r(i), g = de.options.toPadding(i.padding),
                            Y = de.toRadians(P.labelRotation), N = [], U = L.drawBorder ? un(L.lineWidth, 0, 0) : 0,
                            j = de._alignPixel;
                        ...
                        if (de.each(a, function (e, t) {
                            ...
                            if (L.display && t && n && (o.save(), o.lineWidth = t, o.strokeStyle = n, o.setLineDash && (o.setLineDash(e.glBorderDash), o.lineDashOffset = e.glBorderDashOffset), o.beginPath(), L.drawTicks && (o.moveTo(e.tx1, e.ty1), o.lineTo(e.tx2, e.ty2)), L.drawOnChartArea && (o.moveTo(e.x1, e.y1), o.lineTo(e.x2, e.y2)), o.stroke(), o.restore()), s.display) {
                                ...
                                var i = e.label, r = e.textOffset;
                                if (de.isArray(i)) for (var a = 0; a < i.length; ++a) o.fillText("" + i[a], 0, r), r += H; else o.fillText(i, 0, r);
                                o.restore()
                            }
                        }), i.display) {
                            var f, m, b = 0, v = p.lineHeight / 2;
                            if (z) f = P.left + (P.right - P.left) / 2, m = "bottom" === R ? P.bottom - v - g.bottom : P.top + v + g.top; else {
                                var y = "left" === R;
                        ...
                        if (U) {
                            var w, x, k, M, _ = U, S = un(L.lineWidth, a.length - 1, 0);
                ...
                getLabels: function () {
                    ...
                    var n, i = this, r = i.options.offset, a = Math.max(i.maxIndex + 1 - i.minIndex - (r ? 0 : 1), 1);
                    ...
                    if (i.isHorizontal()) {
                        var s = i.width / a, l = s * (t - i.minIndex);
                        return r && (l += s / 2), i.left + l
                    }
                    var c = i.height / a, d = c * (t - i.minIndex);
                    ...
                    var t = this, n = t.options.offset, i = Math.max(t._ticks.length - (n ? 0 : 1), 1),
                        r = t.isHorizontal(), a = (r ? t.width : t.height) / i;
            ...
            mn._defaults = bn;
            var vn = de.noop, yn = de.isNullOrUndef;
            var wn = fn.extend({
                getRightValue: function (e) {
                    ...
                    if (t.beginAtZero) {
                        var n = de.sign(e.min), i = de.sign(e.max);
                ...
                }, handleDirectionalChanges: vn, buildTicks: function () {
                    var e = this, t = e.options.ticks, n = e.getTickLimit(), i = {
                        ...
                        var n, i, r, a, o = [], s = e.stepSize, l = s || 1, c = e.maxTicks - 1, d = e.min, h = e.max,
                            u = e.precision, p = t.min, g = t.max, f = de.niceNum((g - p) / c / l) * l;
            ...
            }), xn = {position: "left", ticks: {callback: dn.formatters.linear}}, kn = wn.extend({
                determineDataLimits: function () {
                    var o = this, s = o.options, l = o.chart, e = l.data.datasets, t = o.isHorizontal();
                    ...
                    if (void 0 === i && de.each(e, function (e, t) {
                        ...
                        de.each(e, function (e, t) {
                            ...
                            var r = d[n].positiveValues, a = d[n].negativeValues;
                            ...
                            var t = e.positiveValues.concat(e.negativeValues), n = de.min(t), i = de.max(t);
            ...
            var Sn = {position: "left", ticks: {callback: dn.formatters.logarithmic}};
            ...
            var Tn = fn.extend({
                determineDataLimits: function () {
                    var o = this, n = o.options, s = o.chart, e = s.data.datasets, t = o.isHorizontal();
                    ...
                    var e = this, t = e.options.ticks, n = !e.isHorizontal(), i = {min: Cn(t.min), max: Cn(t.max)},
                        r = e.ticks = function (e, t) {
                            var n, i, r = [], a = _n(e.min, Math.pow(10, Math.floor(de.log10(t.min)))),
                                o = Math.floor(de.log10(t.max)), s = Math.ceil(t.max / Math.pow(10, o));
                    ...
                    var t, n, i, r, a, o = this, s = o.options.ticks, l = s.reverse, c = de.log10,
                    ...
                    var t, n, i, r, a = this, o = a.options.ticks, s = o.reverse, l = de.log10,
            ...
            Tn._defaults = Pn;
            var Dn = de.valueOrDefault, On = de.valueAtIndexOrDefault, Bn = de.options.resolve, An = {
                display: !0,
                animate: !0,
                position: "chartArea",
                angleLines: {
            ...
            function In(e, t, n, i) {
                var r, a, o = n.y + i / 2;
                if (de.isArray(t)) for (r = 0, a = t.length; r < a; ++r) e.fillText(t[r], n.x, o), o += i; else e.fillText(t, n.x, o)
            }
                ...
                setDimensions: function () {
                    ...
                    e.display && e.pointLabels.display ? function (e) {
                        ...
                        for (t = 0; t < d; t++) {
                            ...
                            var h = e.getIndexAngle(t), u = de.toDegrees(h) % 360, p = Vn(u, i.x, n.w, 0, 180),
                    ...
                    var a = this, e = a.options, o = e.gridLines, s = e.ticks;
                    if (e.display) {
                        var l = a.ctx, c = this.getIndexAngle(0), d = de.options._parseFont(s);
                        (e.angleLines.display || e.pointLabels.display) && function (e) {
                            var t = e.ctx, n = e.options, i = n.angleLines, r = n.gridLines, a = n.pointLabels,
                                o = Dn(i.lineWidth, r.lineWidth), s = Dn(i.color, r.color), l = Rn(n);
                            ...
                            for (var f = Ln(e) - 1; 0 <= f; f--) {
                                ...
                                if (a.display) {
                                    var b = 0 === f ? l / 2 : 0, v = e.getPointPosition(f, p + b + 5),
                                        y = On(a.fontColor, f, se.global.defaultFontColor);
                                    t.fillStyle = y;
                                    var w = e.getIndexAngle(f), x = de.toDegrees(w);
                            ...
                            if (0 < t || s.reverse) {
                                ...
                                if (o.display && 0 !== t && function (e, t, n, i) {
                                    var r, a = e.ctx, o = t.circular, s = Ln(e), l = On(t.color, i - 1),
            ...
            Hn._defaults = Fn;
            var Wn = de.valueOrDefault, En = Number.MIN_SAFE_INTEGER || -9007199254740991,
                Yn = Number.MAX_SAFE_INTEGER || 9007199254740991, Nn = {
            ...
            function Zn(e, t) {
                ...
                var n = e.options.time, i = Xn(e, e.getRightValue(t));
                return null === i || n.round && (i = +e._adapter.startOf(i, n.round)), i
            }

            function $n(e) {
                for (var t = Un.indexOf(e) + 1, n = Un.length; t < n; ++t) if (Nn[Un[t]].common) return Un[t]
            }

            function Kn(e, t, n, i) {
                var r, a = e._adapter, o = e.options, s = o.time, l = s.unit || function (e, t, n, i) {
                        var r, a, o, s = Un.length;
                        for (r = Un.indexOf(e); r < s - 1; ++r) if (o = (a = Nn[Un[r]]).steps ? a.steps[a.steps.length - 1] : Yn, a.common && Math.ceil((n - t) / (o * a.size)) <= i) return Un[r];
                        return Un[s - 1]
                    }(s.minUnit, t, n, i), c = $n(l), d = Wn(s.stepSize, s.unitStepSize), h = "week" === l && s.isoWeekday,
                    u = o.ticks.major.enabled, p = Nn[l], g = t, f = n, m = [];
                for (d || (d = function (e, t, n, i) {
                    var r, a, o, s = t - e, l = Nn[n], c = l.size, d = l.steps;
            ...
            var Jn = fn.extend({
                initialize: function () {
                    ...
                    var e, t, n, i, r, a, o = this, s = o.chart, l = o._adapter, c = o.options.time,
                        d = c.unit || "day", h = Yn, u = En, p = [], g = [], f = [], m = s.data.labels || [];
                    for (e = 0, n = m.length; e < n; ++e) f.push(Zn(o, m[e]));
                    for (e = 0, n = (s.data.datasets || []).length; e < n; ++e) if (s.isDatasetVisible(e)) if (r = s.data.datasets[e].data, de.isObject(r[0])) for (g[e] = [], t = 0, i = r.length; t < i; ++t) a = Zn(o, r[t]), p.push(a), g[e][t] = a; else {
                    ...
                    var e, t, n, i, r, a, o, s, l, c, d = this, h = d.min, u = d.max, p = d.options, g = p.time, f = [],
                        m = [];
                    ...
                    return d.min = h, d.max = u, d._unit = g.unit || function (e, t, n, i, r) {
                        var a, o;
                        for (a = Un.length - 1; a >= Un.indexOf(n); a--) if (o = Un[a], Nn[o].common && e._adapter.diff(r, i, o) >= t.length) return o;
                    ...
                    }), p.ticks.reverse && m.reverse(), function (e, t, n) {
                        var i, r, a, o, s = [];
                    ...
                    var r = this._adapter, a = this.options, o = a.time.displayFormats, s = o[this._unit],
                        l = this._majorUnit, c = o[l], d = +r.startOf(e, l), h = a.ticks.major,
                        u = h.enabled && l && c && e === d, p = r.format(e, i || (u ? c : s)),
                        g = u ? h : a.ticks.minor, f = Wn(g.callback, g.userCallback);
                    return f ? f(p, t, n) : p
                    ...
                    var t = this.options.ticks, n = this.ctx.measureText(e).width, i = de.toRadians(t.maxRotation),
                        r = Math.cos(i), a = Math.sin(i);
                    ...
                    var t = this, n = t.options.time.displayFormats.millisecond, i = t.tickFormatFunction(e, 0, [], n),
                        r = t.getLabelWidth(i), a = t.isHorizontal() ? t.width : t.height, o = Math.floor(a / r);
                    return 0 < o ? o : 1
                }
            }), Qn = {
                position: "bottom",
            ...
            Jn._defaults = Qn;
            var ei = {category: mn, linear: kn, logarithmic: Tn, radialLinear: Hn, time: Jn}, ti = {
            ...
            function ri(e) {
                ...
                if ("start" === r ? a = void 0 === n.scaleBottom ? i.bottom : n.scaleBottom : "end" === r ? a = void 0 === n.scaleTop ? i.top : n.scaleTop : void 0 !== n.scaleZero ? a = n.scaleZero : i.getBasePosition ? a = i.getBasePosition() : i.getBasePixel && (a = i.getBasePixel()), null != a) {
                    ...
                    if (de.isFinite(a)) return {x: (t = i.isHorizontal()) ? a : null, y: t ? null : a}
                }
                return null
            }
            ...
            var li = {
                id: "filler", afterDatasetsUpdate: function (e, t) {
                    var n, i, r, a, o, s, l, c = (e.data.datasets || []).length, d = t.propagate, h = [];
            ...
            }, ci = de.noop, di = de.valueOrDefault;
            ...
            var ui = fe.extend({
                initialize: function (e) {
                ...
                }, beforeUpdate: ci, update: function (e, t, n) {
                    var i = this;
                    ...
                    var t = this, n = t.options.labels || {}, e = de.callback(n.generateLabels, [t.chart], t) || [];
                    ...
                    var e = this, t = e.options, i = t.labels, n = t.display, r = e.ctx, a = de.options._parseFont(i),
                        o = a.size, s = e.legendHitBoxes = [], l = e.minSize, c = e.isHorizontal();
                    if (l.height = c ? (l.width = e.maxWidth, n ? 10 : 0) : (l.width = n ? 10 : 0, e.maxHeight), n) if (r.font = a.string, c) {
                        var d = e.lineWidths = [0], h = 0;
                        ...
                        var u = i.padding, p = e.columnWidths = [], g = i.padding, f = 0, m = 0, b = o + u;
                    ...
                    var h = this, u = h.options, p = u.labels, e = se.global, g = e.defaultColor, f = e.elements.line,
                        m = h.width, b = h.lineWidths;
                    if (u.display) {
                        var v, y = h.ctx, t = di(p.fontColor, e.defaultFontColor), n = de.options._parseFont(p),
                            w = n.size;
                        y.textAlign = "left", y.textBaseline = "middle", y.lineWidth = .5, y.strokeStyle = t, y.fillStyle = t, y.font = n.string;
                        var x = hi(p, w), k = h.legendHitBoxes, M = h.isHorizontal();
                        v = M ? {
                        ...
                        de.each(h.legendItems, function (e, t) {
                            var n, i, r, a, o, s = y.measureText(e.text).width, l = x + w / 2 + s, c = v.x, d = v.y;
                            M ? 0 < t && c + l + p.padding > h.left + h.minSize.width && (d = v.y += _, v.line++, c = v.x = h.left + (m - b[v.line]) / 2 + p.padding) : 0 < t && d + _ > h.top + h.minSize.height && (c = v.x = c + h.columnWidths[v.line] + p.padding, d = v.y = h.top + p.padding, v.line++), function (e, t, n) {
                                if (!(isNaN(x) || x <= 0)) {
                                    y.save();
                                    ...
                                    if (y.fillStyle = di(n.fillStyle, g), y.lineCap = di(n.lineCap, f.borderCapStyle), y.lineDashOffset = di(n.lineDashOffset, f.borderDashOffset), y.lineJoin = di(n.lineJoin, f.borderJoinStyle), y.lineWidth = i, y.strokeStyle = di(n.strokeStyle, g), y.setLineDash && y.setLineDash(di(n.lineDash, f.borderDash)), u.labels && u.labels.usePointStyle) {
                                        var r = x * Math.SQRT2 / 2, a = e + x / 2, o = t + w / 2;
                    ...
                    var n, i, r, a = this;
                    if (e >= a.left && e <= a.right && t >= a.top && t <= a.bottom) for (r = a.legendHitBoxes, n = 0; n < r.length; ++n) if (e >= (i = r[n]).left && e <= i.left + i.width && t >= i.top && t <= i.top + i.height) return a.legendItems[n];
                    return null
                }, handleEvent: function (e) {
            ...
            var gi = {
                id: "legend", _element: ui, beforeInit: function (e) {
            ...
            var mi = fe.extend({
                ...
                beforeFit: fi,
                fit: function () {
                    var e = this, t = e.options, n = t.display, i = e.minSize,
                        r = de.isArray(t.text) ? t.text.length : 1, a = de.options._parseFont(t),
                ...
                draw: function () {
                    ...
                    if (n.display) {
                        var i, r, a, o = de.options._parseFont(n), s = o.lineHeight, l = s / 2 + n.padding, c = 0,
                            d = e.top, h = e.left, u = e.bottom, p = e.right;
                        ...
                        var g = n.text;
                        if (de.isArray(g)) for (var f = 0, m = 0; m < g.length; ++m) t.fillText(g[m], 0, f, i), f += s; else t.fillText(g, 0, 0, i);
                        t.restore()
                    }
                }
            });
            ...
            var vi = {}, yi = li, wi = gi, xi = {
                id: "title", _element: mi, beforeInit: function (e) {
            ...
            for (var ki in vi.filler = yi, vi.legend = wi, vi.title = xi, on.helpers = de, function () {
                function d(e, t, n) {
                    var i;
                ...
                function t(e, t, n) {
                    var i = document.defaultView, r = de._getParentNode(e), a = i.getComputedStyle(e)[t],
                        o = i.getComputedStyle(r)[t], s = h(a), l = h(o), c = Number.POSITIVE_INFINITY;
                ...
                de.where = function (e, t) {
                    ...
                    var r = e.skip ? t : e, a = t, o = n.skip ? t : n,
                        ...
                        l = Math.sqrt(Math.pow(o.x - a.x, 2) + Math.pow(o.y - a.y, 2)), c = s / (s + l),
                        d = l / (s + l), h = i * (c = isNaN(c) ? 0 : c), u = i * (d = isNaN(d) ? 0 : d);
                    return {
                    ...
                    var n = Math.floor(de.log10(e)), i = e / Math.pow(10, n);
                    ...
                    var l = parseFloat(de.getStyle(a, "padding-left")), c = parseFloat(de.getStyle(a, "padding-top")),
                        d = parseFloat(de.getStyle(a, "padding-right")),
                        h = parseFloat(de.getStyle(a, "padding-bottom")), u = o.right - o.left - l - d,
            ...
            return "undefined" != typeof window && (window.Chart = on), (on.Chart = on).Legend = vi.legend._element, on.Title = vi.title._element, on.pluginService = on.plugins, on.PluginBase = on.Element.extend({}), on.canvasHelpers = on.helpers.canvas, on.layoutService = on.layouts, on.LinearScaleBase = wn, on.helpers.each(["Bar", "Bubble", "Doughnut", "Line", "PolarArea", "Radar", "Scatter"], function (n) {
                on[n] = function (e, t) {
                    return new on(e, on.helpers.merge(t || {}, {type: n.charAt(0).toLowerCase() + n.slice(1)}))
                }
            }), Mi
        ...
        t = this, n = function () {
            ...
            function w(e, t) {
                var n, i, r;
                if (c(t._isAMomentObject) || (e._isAMomentObject = t._isAMomentObject), c(t._i) || (e._i = t._i), c(t._f) || (e._f = t._f), c(t._l) || (e._l = t._l), c(t._strict) || (e._strict = t._strict), c(t._tzm) || (e._tzm = t._tzm), c(t._isUTC) || (e._isUTC = t._isUTC), c(t._offset) || (e._offset = t._offset), c(t._pf) || (e._pf = b(t)), c(t._locale) || (e._locale = t._locale), 0 < a.length) for (n = 0; n < a.length; n++) c(r = t[i = a[n]]) || (e[i] = r);
                return e
            }
            ...
            var j = /\d/, G = /\d\d/, q = /\d{3}/, X = /\d{4}/, Z = /[+-]?\d{6}/, $ = /\d\d?/, K = /\d\d\d\d?/,
            ...
            var ge = 0, fe = 1, me = 2, be = 3, ve = 4, ye = 5, we = 6, xe = 7, ke = 8;
            ...
            function Re(e, t) {
                ...
                if ("string" == typeof t) if (/^\d+$/.test(t)) t = _(t); else if (!d(t = e.localeData().monthsParse(t))) return e;
            ...
            function Ye(e, t, n) {
                var i, r, a = We(e.year(), t, n), o = Math.floor((e.dayOfYear() - a - 1) / 7) + 1;
            ...
            function pt(e) {
                ...
                if (!e._d) {
                    ...
                    for (s = e, l = new Date(u.now()), i = s._useUTC ? [l.getUTCFullYear(), l.getUTCMonth(), l.getUTCDate()] : [l.getFullYear(), l.getMonth(), l.getDate()], e._w && null == e._a[me] && null == e._a[fe] && function (e) {
                        var t, n, i, r, a, o, s, l;
                        if (null != (t = e._w).GG || null != t.W || null != t.E) a = 1, o = 4, n = ut(t.GG, e._a[ge], Ye(Pt(), 1, 4).year), i = ut(t.W, 1), ((r = ut(t.E, 1)) < 1 || 7 < r) && (l = !0); else {
            ...
            function wt(e) {
                var t, n, i, r, a, o, s = e._i, l = gt.exec(s) || ft.exec(s);
                if (l) {
                    for (b(e).iso = !0, t = 0, n = bt.length; t < n; t++) if (bt[t][1].exec(l[1])) {
                        r = bt[t][0], i = !1 !== bt[t][2];
                        break
                    }
            ...
            function St(e) {
                if (e._f !== u.ISO_8601) if (e._f !== u.RFC_2822) {
                    e._a = [], b(e).empty = !0;
                    var t, n, i, r, a, o, s, l, c = "" + e._i, d = c.length, h = 0;
            ...
            function Ct(e) {
                var t, n, i, r, a = e._i, o = e._f;
                return e._locale = e._locale || dt(e._l), null === a || void 0 === o && "" === a ? y({nullInput: !0}) : ("string" == typeof a && (e._i = a = e._locale.preparse(a)), k(a) ? new x(ht(a)) : (h(a) ? e._d = a : s(o) ? function (e) {
                    var t, n, i, r, a;
            ...
            function Lt(e) {
                var t = R(e), n = t.year || 0, i = t.quarter || 0, r = t.month || 0, a = t.week || t.isoWeek || 0,
                ...
                this._isValid = function (e) {
                    ...
                    for (var n = !1, i = 0; i < At.length; ++i) if (e[At[i]]) {
                        if (n) return !1;
            ...
            function Ht(e, t) {
                ...
                var i = ((n[n.length - 1] || []) + "").match(zt) || ["-", 0, 0], r = 60 * i[1] + _(i[2]);
            ...
            function Xt(e, t, n, i) {
                var r = t._milliseconds, a = Vt(t._days), o = Vt(t._months);
            ...
            var Zt = qt(1, "add"), $t = qt(-1, "subtract");
            ...
            function sn(e, t, n, i, r) {
                ...
                return null == e ? Ye(this, i, r).year : ((a = Ne(e, i, r)) < t && (t = a), function (e, t, n, i, r) {
                    var a = Ee(e, t, n, i, r), o = Fe(a.year, 0, a.dayOfYear);
            ...
            gn.add = Zt, gn.calendar = function (e, t) {
                var n = e || Pt(), i = Ft(n, this).startOf("day"), r = u.calendarFormat(this, i) || "sameElse",
                ...
                }(e = R(e)), i = 0; i < n.length; i++) this[n[i].unit](e[n[i].unit]); else if (P(this[e = L(e)])) return this[e](t);
                return this
            ...
            mn.calendar = function (e, t, n) {
                ...
                if (this._monthsParseExact) return function (e, t, n) {
                    ...
                    if (!this._monthsParse) for (this._monthsParse = [], this._longMonthsParse = [], this._shortMonthsParse = [], i = 0; i < 12; ++i) a = m([2e3, i]), this._shortMonthsParse[i] = this.monthsShort(a, "").toLocaleLowerCase(), this._longMonthsParse[i] = this.months(a, "").toLocaleLowerCase();
            ...
            var Cn = Sn("ms"), Tn = Sn("s"), Pn = Sn("m"), Dn = Sn("h"), On = Sn("d"), Bn = Sn("w"), An = Sn("M"),
                Ln = Sn("Q"), Rn = Sn("y");
            ...
            var In = Vn("milliseconds"), zn = Vn("seconds"), Hn = Vn("minutes"), Fn = Vn("hours"), Wn = Vn("days"),
                En = Vn("months"), Yn = Vn("years");
            var Nn = Math.round, Un = {ss: 44, s: 45, m: 45, h: 22, d: 26, M: 11};
            var jn = Math.abs;
            ...
            function qn() {
                ...
                var a = M(r / 12), o = r %= 12, s = i, l = t, c = e, d = n ? n.toFixed(3).replace(/\.?0+$/, "") : "",
                    h = this.asSeconds();
                if (!h) return "P0D";
                var u = h < 0 ? "-" : "", p = Gn(this._months) !== Gn(h) ? "-" : "",
                    g = Gn(this._days) !== Gn(h) ? "-" : "", f = Gn(this._milliseconds) !== Gn(h) ? "-" : "";
    ...
    }, {"../utils/app.core": 43}], 5: [function (e, t, n) {
        "use strict";
        e("../utils/app.core");
    ...
    }, {"../utils/app.core": 43}], 6: [function (e, t, n) {
        "use strict";
        var r = function (n) {
            var i, r, e = n.querySelector(".counter-control.substract"), t = n.querySelector(".counter-control.add");
        ...
        !function () {
            ...
            if (e.length) {
                var t = function e() {
                    this.querySelector(".post-preview-overlay").style.visibility = "hidden", this.querySelector(".post_preview_img").style.visibility = "hidden", this.querySelector(".post-preview-video-wrap").style.visibility = "visible", this.removeEventListener("click", e)
                };
                e.forEach(function (e) {
    ...
    }, {"../utils/app.core": 43}], 11: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createSlider({
    ...
    }, {"../utils/app.core": 43}], 12: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createArc({
    ...
    }, {"../utils/app.core": 43}], 13: [function (e, t, n) {
        "use strict";
        var i;
        ...
        var a = e("../utils/app.core"), o = (new Date).getFullYear(), s = (new Date).getMonth();
        a.createCalendar({
    ...
    }, {"../utils/app.core": 43}], 14: [function (e, t, n) {
        "use strict";
        var i = e("../../js/utils/app.core"), r = document.querySelector(".chart-bars");
        i.createChart(r, {
            type: "bar",
            data: {
                ...
                }, {label: "WINS", data: [4, 2, 7, 6, 3, 1, 4, 8, 5, 2, 8, 3], backgroundColor: "#00e3d0"}]
            },
            options: {
                legend: {display: !1},
                tooltips: {
                ...
                scales: {
                    ...
                    yAxes: [{
                        gridLines: {color: "#f1f1f1", drawBorder: !1, drawTicks: !1, zeroLineColor: "#f1f1f1"},
                        ticks: {beginAtZero: !0}
                    }]
                }
            }
        ...
        i.createChart(o, {
            ...
            options: {
                ...
                scales: {
                    xAxes: [{gridLines: {color: "#f1f1f1", drawBorder: !1, zeroLineColor: "#f1f1f1"}}],
                    yAxes: [{
                        gridLines: {color: "#f1f1f1", drawBorder: !1, zeroLineColor: "#f1f1f1"},
                        ticks: {beginAtZero: !0}
                    }]
                }
            }
        })
    }, {"../../js/utils/app.core": 43}], 15: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core"), r = new Date,
    ...
    }, {"../utils/app.core": 43}], 16: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createDropdown({
            ...
            selectable: !0,
            options: {container: ".dp-option", current: "#ew1-match-selector-dropdown-option-value"}
        }), i.createDropdown({
    ...
    }, {"../utils/app.core": 43}], 17: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/app.core": 43}], 19: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createProgressBar({
            container: "#ew1-pgb-1",
            ...
            buttEnd: !0,
            breakpoints: {960: {width: 400, height: 6}, 480: {width: 210, height: 6}}
        }), i.createProgressBar({
            container: "#ew1-pgb-4",
            width: 812,
            height: 6,
    ...
    }, {"../utils/app.core": 43}], 20: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createSlider({
            ...
            controls: {container: "#ew1-cmrf-controls", disabledClass: "disabled"},
            stopAtEnd: !0
        }), i.createSlider({
            ...
            controls: {container: "#ew1-cmr-controls", disabledClass: "disabled"},
            stopAtEnd: !0
        }), i.createSlider({
    ...
    }, {"../utils/app.core": 43}], 21: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createTab({container: "#tab-login-register"}), i.createTab({container: "#tab-product-page"})
    }, {"../utils/app.core": 43}], 22: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createTooltip({
    ...
    }, {"../utils/app.core": 43}], 23: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createArc({
    ...
    }, {"../utils/app.core": 43}], 24: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/app.core": 43}], 25: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createDropdown({
            ...
            selectable: !0,
            options: {container: ".widget-option", current: "#lang-dropdown-option-value"}
        }), i.createDropdown({
            dropdownSelector: "#curr-dropdown",
            dropdownHandler: "#curr-dropdown-trigger",
            offset: {top: 54, left: 40},
            selectable: !0,
            options: {container: ".widget-option", current: "#curr-dropdown-option-value"},
            ...
            offset: {top: 54, left: -10},
            selectable: !0,
            options: {container: ".widget-option", current: "#lang-dropdown-option-value-2"}
        }), i.createDropdown({
            dropdownSelector: "#curr-dropdown-2",
            dropdownHandler: "#curr-dropdown-trigger-2",
            offset: {top: 54, left: 40},
            selectable: !0,
            options: {container: ".widget-option", current: "#curr-dropdown-option-value-2"},
            breakpoints: {960: {offset: {left: -10}}}
        }), i.createDropdown({
    ...
    }, {"../utils/app.core": 43}], 26: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createArc({
    ...
    }, {"../utils/app.core": 43}], 27: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core"), r = document.querySelector(".inventory-button"),
            a = document.querySelector(".inventory-bag-preview"), o = document.querySelector(".inventory-close-button");
        if (a && r && o) {
            var s = !1, l = i.createOverlay();
    ...
    }, {"../utils/app.core": 43}], 28: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core"), r = document.querySelector(".mobile-menu-wrap"),
            a = document.querySelector(".mobile-menu-open"), o = document.querySelector(".mobile-menu-close");
        if (r && a && o) {
            ...
            a.addEventListener("click", function () {
                r.classList.add("open"), s.show(), s.addTrigger({event: "click", callback: l})
    ...
    }, {"../utils/app.core": 43}], 29: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createProgressBar({
            container: "#mn-pg-1",
    ...
    }, {"../utils/app.core": 43}], 30: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core"), r = document.querySelectorAll(".search-popup-open"),
            a = document.querySelectorAll(".search-popup-close"), o = document.querySelector(".search-popup"),
            s = document.querySelector(".input-line"), l = document.querySelector(".search-popup-text");
        if (r && a && o && s && l) {
    ...
    }, {"../utils/app.core": 43}], 31: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createSlider({
    ...
    }, {"../utils/app.core": 43}], 32: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createArc({
            container: "#banner-top-8_5",
            width: 112,
            height: 112,
            lineWidth: 10,
            gradient: {colors: ["#5216fd", "#ff055d"]},
    ...
    }, {"../utils/app.core": 43}], 33: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createProgressBar({
            container: "#rv-gg-7_5",
            ...
            linkUnits: !1,
            linkText: !0,
            barText: "Fishing Progression"
        })
    }, {"../utils/app.core": 43}], 34: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createSlider({
            ...
            rosterContainer: !1,
            controls: {container: "#po-slideshow1-controls"},
            animation: {type: "fade", orientation: "horizontal", slideDelay: 5e3, slideTransition: 1e3}
        }), i.createSlider({
    ...
    }, {"../utils/app.core": 43}], 35: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core");
        i.createArc({
    ...
    }, {"../utils/app.core": 43}], 36: [function (e, t, n) {
        "use strict";
        var i;
    ...
    }, {"../utils/app.core": 43}], 37: [function (e, t, n) {
        "use strict";
        var i = e("../utils/app.core"), r = new Date,
            a = {day: r.getDate(), month: r.getMonth(), year: r.getFullYear()};
        i.createCountdown({
    ...
    }, {"../utils/app.core": 43}], 38: [function (e, t, n) {
        "use strict";
        ...
        i.createProgressBar({
            ...
            gradient: {colors: ["#713fcb", "#00e3d0"]},
            split: {
                partItems: [{width: 30, gap: 4}, {width: 40, gap: 4}, {width: 50, gap: 4}, {
                    width: 60,
                    gap: 4
                }, {width: 74, gap: 4}], color: "#fff"
            }
        }), i.createProgressBar({
    ...
    }, {"../utils/app.core": 43}], 40: [function (e, t, n) {
        "use strict";
        e("../utils/app.core").createSlider({
            ...
            controls: {container: "#award-slider-controls", disabledClass: "disabled"}
        })
    }, {"../utils/app.core": 43}], 41: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/app.core": 43}], 42: [function (e, t, n) {
        "use strict";
        ...
        "use strict";
        var i = e("chart.js"), r = e("./Overlay"), a = {
        ...
        t.exports = a
    }, {"./Overlay": 42, "chart.js": 1}], 44: [function (e, t, n) {
        "use strict";
    ...
    }, {"../utils/content-loader": 44}], 46: [function (e, t, n) {
        "use strict";
        ...
        "use strict";
        var i = document.querySelectorAll(".tweets-preview-widget"), r = function (e, t) {
