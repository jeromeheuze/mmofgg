...
<!--                        <a href="/tags/albion-online/">Albion Online</a>-->
            ...
            <div class="col-lg-3 col-sm-6">
                <div class="widget widget_recent_post">
                    <h5 class="widget-title">POPULAR GAMES</h5>
                    <?php
...
<!--                                <img src="--><?php //=$row['post_preview_icon'];?><!--" alt="img">-->
<!--                            </div>-->
<!--                            <div class="media-body">-->
<!--                                <div class="details">-->
<!--                                    <div class="post-meta-single">-->
<!--                                        <ul>-->
<!--                                            <li><i class="fa fa-clock-o"></i>--><?php //=date("F d, Y", strtotime($row["created"]))?><!--</li>-->
<!--                                        </ul>-->
<!--                                    </div>-->
<!--                                    <h6 class="title"><a href="--><?php //=$row['post_preview_url'];?><!--">--><?php //=$row['post_preview_title'];?><!--</a></h6>-->
<!--                                </div>-->
<!--                            </div>-->
<!--                        </div>-->
<!--                    </div>-->
...
<!--                <li><a href="#">About</a></li>-->
            ...
            <p>Copyright ©<?=date("Y");?> MMO Fishing Games - Developed by <a href="https://jeromeheuze.com/" target="_blank">Jerome Heuze</a> - <a href="https://name.sjv.io/K0Ej4e" target="_blank">Cast your line into the vast web and reel in the perfect domain</a> </p>
        </div>
    </div>
</div>