...
<div class="widget-sidebar">
    ...
    <div class="post-preview-showcase grid-1col centered gutter-small">
        ...
        <?php
        $query_reviews4x = "SELECT * FROM content WHERE active='1' && type='reviews' LIMIT 4";
        mysqli_set_charset($DBcon,"utf8");
        $result_reviews4x = $DBcon->query($query_reviews4x);
        while ($row = $result_reviews4x->fetch_assoc()) {
        ?>
        <div class="post-preview tiny game-review">
            ...
            <div class="post-author-info-wrap">
                <p class="post-author-info small light">By <span class="post-author"><?=$row["post_author"]?></span>
