        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="breadcrumb-inner">
                    <h5 class="page-title">Submit A Game</h5>
                    <ul class="page-list">
                        <li><a href="/">Home</a></li>
                        <li>Send us a game</li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <div class="col-lg-12 pd-top-50">
                <form id="sag">
                    ...
                    <textarea class="form-control" id="description" name="description" rows="5" cols="30" required></textarea>
                    </div>

                    <div class="form-group">
                    <label for="developer">Developer Name:</label>
                    <input class="form-control" type="text" id="developer" name="developer" required>
                    </div>
                    ...
                    <button class="btn-base btn" type="submit">Submit Game</button>
                </form>
                <div id="msg"></div>
            </div>
        </div>
...
<script type="text/javascript">
    jQuery(document).ready(function() {
        ...
        $('#sag').on('submit', function (e) {
            e.preventDefault();
            $.ajax({
                type: 'POST',
                url: '/bin/submit_game.php',
                data: $(this).serialize(),
                dataType: 'json',
