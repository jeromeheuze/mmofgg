...
app.createLineslide({
  ...
  lineslideItems: [
    {
      title: '<a href="/" class="link">The "Clash of Eternity" new game was just released: </a>',
    ...
    {
      title: '<a href="/" class="link">We reviewed the new Magimons game: </a>',
    ...
    {
      title: '<a href="/" class="link">We reviewed the "Guardians of the Universe" movie: </a>',
      content: 'The latest movie from the franchise has a lot of interesting and fun stuff to look for',
      separator: '<span class="separator"><span class="separator-bar">/</span><span class="separator-bar">/</span></span>'
    },
    {
      title: '<a href="/" class="link">Check out some Hearte Bunny original design ideas: </a>',
      content: 'Also, get a sneak peak of the new season looks',
      separator: '<span class="separator"><span class="separator-bar">/</span><span class="separator-bar">/</span></span>'
    },
    {
      title: '<a href="/" class="link">Last night the Wolves beat the Rhinos 12-10: </a>',
